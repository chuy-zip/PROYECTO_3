...
ggplot(data, aes(x = Edadif, fill = Cluster)) +
  ...
  coord_cartesian(xlim = c(0, 100))  # Ajusta estos valores según tus datos
...
data %>%
  ...
  scale_fill_brewer(palette = "Set1") +
  coord_flip() +
  labs(title = "Top 5 Causas de Defunción por Cluster",
       x = "",
       y = "Frecuencia") +
  theme_minimal() +
...
data %>%
  ...
  scale_fill_brewer(palette = "Set1") +
  coord_flip() +
  labs(title = "Top 5 Códigos de Asistencia Médica por Cluster",
